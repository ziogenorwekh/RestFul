...
public class MemberResource {
    ...
    public ResponseEntity<EntityModel<MemberRespVo>> retrieveUsers(@PathVariable Long id) {
...
//        참조 설정
    ...
    public ResponseEntity<MemberRespVo> update(@PathVariable Long id, @RequestBody @Validated MemberReqVo memberReqVo) {
        Member member = memberService.update(id, memberReqVo);
        MemberRespVo respVo = new ModelMapper().map(member, MemberRespVo.class);
        return ResponseEntity.accepted().body(respVo);
    }
